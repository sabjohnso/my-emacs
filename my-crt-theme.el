;;; my-crt-theme.el --- CRT phosphor dark theme -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; A dark Emacs theme evoking 1980s CRT terminals with green (P1) and
;; amber (P3) phosphor colors on a near-black background.  Comprehensive
;; face coverage including tuareg, merlin, and utop faces for OCaml
;; development.
...
(deftheme my-crt "CRT phosphor dark theme.")

(defgroup my-crt-theme nil
  "Faces for my-crt theme."
  :group 'faces)

(defcustom my-crt-scale-org-headlines t
...
(provide-theme 'my-crt)
;;; my-crt-theme.el ends here
