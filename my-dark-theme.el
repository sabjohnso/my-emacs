;;; my-dark-theme.el --- Deep navy dark theme with OCaml support -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; A dark Emacs theme with a deep navy background (#1a1a2e), preserving
;; the leuven spirit with carefully chosen colors.  Comprehensive face
;; coverage including tuareg, merlin, and utop faces for OCaml development.

;;; Code:

(require 'my-theme-palette)

(deftheme my-dark "Deep navy dark theme with OCaml support.")

(defgroup my-dark-theme nil
  "Faces for my-dark theme."
  :group 'faces)

(defcustom my-dark-scale-org-headlines t
