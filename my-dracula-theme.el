;;; my-dracula-theme.el --- Dracula theme with OCaml support -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Dracula Emacs theme using Zeno Rocha's canonical palette
;; (#282a36).  Comprehensive face coverage including tuareg, merlin,
...
(deftheme my-dracula "Dracula theme with OCaml support.")

(defgroup my-dracula-theme nil
  "Faces for my-dark theme."
  :group 'faces)

(defcustom my-dracula-scale-org-headlines t
  "Whether to scale Org headlines."
  :type 'boolean
  :group 'my-dracula-theme)
