...
(defun my-theme-palette--light ()
  ...
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#FF6347")
    (org-done-fg     . "#008000")
    (org-active-fg   . "#0077CC")
    (org-waiting-fg  . "#FF8C00")
    (org-cancelled-fg . "#999999")
    (org-block-bg    . "#FFFFEA")
    (org-code-bg     . "#F5F5F5")
    (org-code-fg     . "#7F0055")
    (org-table-bg    . "#E8E5D5")
...
(defun my-theme-palette--dark ()
  ...
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#f7768e")
    (org-done-fg     . "#9ece6a")
    (org-active-fg   . "#7aa2f7")
    (org-waiting-fg  . "#e0af68")
    (org-cancelled-fg . "#565f89")
    (org-block-bg    . "#16213e")
    (org-code-bg     . "#1e1e3a")
    (org-code-fg     . "#ff9e64")
    (org-table-bg    . "#1e1e3a")
...
Uses xterm-256 `color-NNN' names for terminals without true color."
  '(;; --- Base ---
    ...
    (org-active-fg   . "color-33")
    (org-waiting-fg  . "color-208")
    (org-cancelled-fg . "color-245")
...
Uses Ethan Schoonover's canonical Solarized palette."
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#dc322f")
    (org-done-fg     . "#859900")
    (org-active-fg   . "#268bd2")
    (org-waiting-fg  . "#b58900")
    (org-cancelled-fg . "#586e75")
    (org-block-bg    . "#073642")
    (org-code-bg     . "#003340")
    (org-code-fg     . "#cb4b16")
    (org-table-bg    . "#003340")
...
Uses morhetz's canonical Gruvbox palette."
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#fb4934")
    (org-done-fg     . "#b8bb26")
    (org-active-fg   . "#83a598")
    (org-waiting-fg  . "#fabd2f")
    (org-cancelled-fg . "#665c54")
    (org-block-bg    . "#3c3836")
    (org-code-bg     . "#32302f")
    (org-code-fg     . "#fe8019")
    (org-table-bg    . "#32302f")
...
Uses the canonical Dracula palette by Zeno Rocha."
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#ff5555")
    (org-done-fg     . "#50fa7b")
    (org-active-fg   . "#8be9fd")
    (org-waiting-fg  . "#f1fa8c")
    (org-cancelled-fg . "#6272a4")
    (org-block-bg    . "#21222c")
    (org-code-bg     . "#2c2e3e")
    (org-code-fg     . "#ffb86c")
    (org-table-bg    . "#2c2e3e")
...
Uses Arctic Ice Studio's canonical Nord palette."
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#bf616a")
    (org-done-fg     . "#a3be8c")
    (org-active-fg   . "#88c0d0")
    (org-waiting-fg  . "#ebcb8b")
    (org-cancelled-fg . "#4c566a")
    (org-block-bg    . "#3b4252")
    (org-code-bg     . "#353c4a")
    (org-code-fg     . "#d08770")
    (org-table-bg    . "#353c4a")
...
Evokes green (P1) and amber (P3) phosphor monitors from the 1980s."
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#ff3333")
    (org-done-fg     . "#33ff33")
    (org-active-fg   . "#00cccc")
    (org-waiting-fg  . "#cccc00")
    (org-cancelled-fg . "#336633")
    (org-block-bg    . "#0e0e0e")
    (org-code-bg     . "#111611")
    (org-code-fg     . "#ff9933")
    (org-table-bg    . "#111611")
...
Inspired by the Tron universe — deep black with electric cyan and orange."
  '(;; --- Base ---
    ...
    (org-todo-fg     . "#df3030")
    (org-done-fg     . "#33ff33")
    (org-active-fg   . "#6fc3df")
    (org-waiting-fg  . "#dfaf20")
    (org-cancelled-fg . "#3a5a5a")
    (org-block-bg    . "#0c0e14")
    (org-code-bg     . "#0f1117")
    (org-code-fg     . "#df740c")
    (org-table-bg    . "#0f1117")
