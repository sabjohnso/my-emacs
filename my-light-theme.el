;;; my-light-theme.el --- Leuven-inspired light theme with OCaml support -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; A light Emacs theme inspired by leuven, with refined colors and
...
(deftheme my-light "Leuven-inspired light theme with OCaml support.")

(defgroup my-light-theme nil
  "Faces for my-light theme."
  :group 'faces)

(defcustom my-light-scale-org-headlines t
