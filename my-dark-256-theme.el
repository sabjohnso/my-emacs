;;; my-dark-256-theme.el --- Dark theme for 256-color terminals -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; A dark Emacs theme using xterm-256 color names for terminals without
;; true color support.  Structurally identical to my-dark-theme but
;; pulls from the dark-256 palette.

;;; Code:

(require 'my-theme-palette)

(deftheme my-dark-256 "Dark theme for 256-color terminals.")

(defgroup my-dark-256-theme nil
  "Faces for my-dark-256 theme."
  :group 'faces)

(defcustom my-dark-256-scale-org-headlines t
  "Whether to scale Org headlines."
  :type 'boolean
  :group 'my-dark-256-theme)
...
(provide-theme 'my-dark-256)
;;; my-dark-256-theme.el ends here
