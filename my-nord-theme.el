;;; my-nord-theme.el --- Nord theme with OCaml support -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Nord Emacs theme using Arctic Ice Studio's canonical palette
;; (#2e3440).  Comprehensive face coverage including tuareg, merlin,
...
(deftheme my-nord "Nord theme with OCaml support.")

(defgroup my-nord-theme nil
  "Faces for my-dark theme."
  :group 'faces)

(defcustom my-nord-scale-org-headlines t
...
(provide-theme 'my-nord)
;;; my-nord-theme.el ends here
