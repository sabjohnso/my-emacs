;;; my-solarized-dark-theme.el --- Solarized Dark theme with OCaml support -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Solarized Dark Emacs theme using Ethan Schoonover's canonical
;; palette (#002b36).  Comprehensive face coverage including tuareg,
;; merlin, and utop faces for OCaml development.

;;; Code:

(require 'my-theme-palette)

(deftheme my-solarized-dark "Solarized Dark theme with OCaml support.")

(defgroup my-solarized-dark-theme nil
  "Faces for my-dark theme."
  :group 'faces)

(defcustom my-solarized-dark-scale-org-headlines t
  "Whether to scale Org headlines."
  :type 'boolean
  :group 'my-solarized-dark-theme)
